...
export default function ReadthemPage() {
  ...
  return <main>
    <header className="header"><a className="logo" href="/" aria-label="ALLDAY PROJECT" /><nav><a href="#features">기능</a><a href="#how">작동 방식</a><a href="#widget">위젯</a></nav><button className="button small" type="button" onClick={showLaunchNotice}><GithubIcon /> <span>GitHub으로 시작</span></button></header>
